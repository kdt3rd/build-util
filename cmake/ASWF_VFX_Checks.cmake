...
macro(ASWF_ENABLE_VFX_PLATFORM)
  ...
  if(ASWF_VFXPLAT_VERSION STREQUAL "VFX_2014")
    map_set(ASWF_VFXLIB_VERSIONS gcc 4.1.2)
    map_set(ASWF_VFXLIB_VERSIONS python 2.7.3)
    map_set(ASWF_VFXLIB_VERSIONS qt 4.8.5)
    map_set(ASWF_VFXLIB_VERSIONS pyside 1.2)
    map_set(ASWF_VFXLIB_VERSIONS openexr 2.0.1)
    map_set(ASWF_VFXLIB_VERSIONS opensubdiv 2.3.3)
    map_set(ASWF_VFXLIB_VERSIONS alembic 1.5)
    map_set(ASWF_VFXLIB_VERSIONS fbx 2015)
    map_set(ASWF_VFXLIB_VERSIONS ocio 1.0.7)
    map_set(ASWF_VFXLIB_VERSIONS boost 1.53)
    map_set(ASWF_VFXLIB_VERSIONS tbb 4.1)
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard 98)
    set(CMAKE_CXX_STANDARD 98)
  elseif(ASWF_VFXPLAT_VERSION STREQUAL "VFX_2015")
    map_set(ASWF_VFXLIB_VERSIONS gcc 4.8.2)
    map_set(ASWF_VFXLIB_VERSIONS glibc 2.12)
    map_set(ASWF_VFXLIB_VERSIONS python 2.7)
    map_set(ASWF_VFXLIB_VERSIONS qt 4.8)
    map_set(ASWF_VFXLIB_VERSIONS pyside 1.2)
    map_set(ASWF_VFXLIB_VERSIONS openexr 2.2)
    map_set(ASWF_VFXLIB_VERSIONS opensubdiv 2.5)
    map_set(ASWF_VFXLIB_VERSIONS openvdb 3.0)
    map_set(ASWF_VFXLIB_VERSIONS alembic 1.5)
    map_set(ASWF_VFXLIB_VERSIONS fbx 2015)
    map_set(ASWF_VFXLIB_VERSIONS ocio 1.0.9)
    map_set(ASWF_VFXLIB_VERSIONS boost 1.55)
    map_set(ASWF_VFXLIB_VERSIONS tbb 4.2)
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard 98)
    set(CMAKE_CXX_STANDARD 98)
  elseif(ASWF_VFXPLAT_VERSION STREQUAL "VFX_2016")
    # impossible to check for 4.8.2 w/ bugfix?
    map_set(ASWF_VFXLIB_VERSIONS gcc 4.8.3)
    map_set(ASWF_VFXLIB_VERSIONS glibc 2.12)
    map_set(ASWF_VFXLIB_VERSIONS python 2.7.5)
    map_set(ASWF_VFXLIB_VERSIONS qt 5.6.1)
    map_set(ASWF_VFXLIB_VERSIONS pyqt 5.6)
    map_set(ASWF_VFXLIB_VERSIONS pyside 2.0)
    map_set(ASWF_VFXLIB_VERSIONS numpy 1.9.2)
    map_set(ASWF_VFXLIB_VERSIONS openexr 2.2)
    map_set(ASWF_VFXLIB_VERSIONS ptex 2.0.42)
    map_set(ASWF_VFXLIB_VERSIONS opensubdiv 3.0)
    map_set(ASWF_VFXLIB_VERSIONS openvdb 3)
    map_set(ASWF_VFXLIB_VERSIONS alembic 1.5.8)
    map_set(ASWF_VFXLIB_VERSIONS fbx 2015)
    map_set(ASWF_VFXLIB_VERSIONS ocio 1.0.9)
    map_set(ASWF_VFXLIB_VERSIONS aces 1.0)
    map_set(ASWF_VFXLIB_VERSIONS boost 1.55)
    map_set(ASWF_VFXLIB_VERSIONS tbb 4.3)
    map_set(ASWF_VFXLIB_VERSIONS mkl 11.3)
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard 11)
  ...
  elseif(ASWF_VFXPLAT_VERSION STREQUAL "VFX_2017")
    ...
    map_set(ASWF_VFXLIB_VERSIONS numpy 1.9.2)
    map_set(ASWF_VFXLIB_VERSIONS openexr 2.2)
    map_set(ASWF_VFXLIB_VERSIONS ptex 2.1.28)
    map_set(ASWF_VFXLIB_VERSIONS opensubdiv 3.3)
    map_set(ASWF_VFXLIB_VERSIONS openvdb 4)
    map_set(ASWF_VFXLIB_VERSIONS alembic 1.6)
    map_set(ASWF_VFXLIB_VERSIONS fbx 2015)
    map_set(ASWF_VFXLIB_VERSIONS ocio 1.0.9)
    map_set(ASWF_VFXLIB_VERSIONS aces 1.0)
    map_set(ASWF_VFXLIB_VERSIONS boost 1.61)
    map_set(ASWF_VFXLIB_VERSIONS tbb 4.4)
    map_set(ASWF_VFXLIB_VERSIONS mkl 11.3)
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard 11)
    set(CMAKE_CXX_STANDARD 11)
  elseif(ASWF_VFXPLAT_VERSION STREQUAL "VFX_2018")
    map_set(ASWF_VFXLIB_VERSIONS gcc 6.3.1)
    map_set(ASWF_VFXLIB_VERSIONS glibc 2.17)
    map_set(ASWF_VFXLIB_VERSIONS python 2.7.5)
    map_set(ASWF_VFXLIB_VERSIONS qt 5.6.1)
    map_set(ASWF_VFXLIB_VERSIONS pyqt 5.6)
    map_set(ASWF_VFXLIB_VERSIONS pyside 2.0)
    map_set(ASWF_VFXLIB_VERSIONS numpy 1.12.1)
    map_set(ASWF_VFXLIB_VERSIONS openexr 2.2)
    map_set(ASWF_VFXLIB_VERSIONS ptex 2.1.28)
    map_set(ASWF_VFXLIB_VERSIONS opensubdiv 3.3)
    map_set(ASWF_VFXLIB_VERSIONS openvdb 5)
    map_set(ASWF_VFXLIB_VERSIONS alembic 1.7)
    map_set(ASWF_VFXLIB_VERSIONS fbx 2018)
    map_set(ASWF_VFXLIB_VERSIONS ocio 1.0.9)
    map_set(ASWF_VFXLIB_VERSIONS aces 1.0.3)
    map_set(ASWF_VFXLIB_VERSIONS boost 1.61)
    map_set(ASWF_VFXLIB_VERSIONS tbb 2017.6)
    map_set(ASWF_VFXLIB_VERSIONS mkl 2017.2)
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard 14)
    set(CMAKE_CXX_STANDARD 14)
  elseif(ASWF_VFXPLAT_VERSION STREQUAL "VFX_2019")
    map_set(ASWF_VFXLIB_VERSIONS gcc 6.3.1)
    map_set(ASWF_VFXLIB_VERSIONS glibc 2.17)
    map_set(ASWF_VFXLIB_VERSIONS python 2.7.9)
    map_set(ASWF_VFXLIB_VERSIONS qt 5.12)
    map_set(ASWF_VFXLIB_VERSIONS pyqt 5.12)
    map_set(ASWF_VFXLIB_VERSIONS pyside 5.12)
    map_set(ASWF_VFXLIB_VERSIONS numpy 1.14.1)
    map_set(ASWF_VFXLIB_VERSIONS openexr 2.3)
    map_set(ASWF_VFXLIB_VERSIONS ptex 2.1.33)
    map_set(ASWF_VFXLIB_VERSIONS opensubdiv 3.3)
    map_set(ASWF_VFXLIB_VERSIONS openvdb 6)
    map_set(ASWF_VFXLIB_VERSIONS alembic 1.7)
    map_set(ASWF_VFXLIB_VERSIONS fbx 2019)
    map_set(ASWF_VFXLIB_VERSIONS ocio 1.1.0)
    map_set(ASWF_VFXLIB_VERSIONS aces 1.1)
    map_set(ASWF_VFXLIB_VERSIONS boost 1.66)
    map_set(ASWF_VFXLIB_VERSIONS tbb 2018)
    map_set(ASWF_VFXLIB_VERSIONS mkl 2018)
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard 14)
    set(CMAKE_CXX_STANDARD 14)
  elseif(ASWF_VFXPLAT_VERSION STREQUAL "none")
    ...
    map_set(ASWF_VFXLIB_VERSIONS cxx_standard ${ASWF_CXX_STANDARD})
  ...
  if(ASWF_VFXPLAT_CHECK_COMPILER)
    if(NOT ASWF_VFXPLAT_VERSION STREQUAL "none")
      map_get(_aswf_tmp ASWF_VFXLIB_VERSIONS gcc)
      aswf_vfx_test_gcc_version(${_aswf_tmp})

      aswf_detect_libc_version()
      map_get(_aswf_tmp ASWF_VFXLIB_VERSIONS glibc)
...
macro(ASWF_SET_VFX_PLATFORM_FLAGS name)
  map_get(_aswf_std ASWF_VFXLIB_VERSIONS cxx_standard 14)
